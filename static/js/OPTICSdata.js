...
class OPTICSData {
    ...
    aggregateReachability(p0, p1) {
        ...
        coordinates.forEach((coordinate, i) => {
            if (this._isInMap(coordinate, p0, p1)) {
...
function getReachability(init_eps = 10) {
...
function updateReachability(eps) {
    ...
    let scope_data = optics_data.aggregateReachability(p0, p1);
    //scope_data.status();
